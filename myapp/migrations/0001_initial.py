# Generated by Django 3.2.12 on 2024-08-10 07:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.CharField(blank=True, default='10 August 2024', max_length=100)),
                ('category', models.ManyToManyField(to='myapp.Category')),
                ('pendidikan', models.ManyToManyField(to='myapp.Pendidikan')),
            ],
        ),
    ]
